    ...
    return (
        <div className='m-5'>
            <div className='bg-primary text-white rounded-lg p-3 '>
                ...
                <div className='h-2 bg-gray-500 w-full rounded-full mt-3'>
                    <div className='h-2 bg-white rounded-full'
                        style={{
                            width: typeof totalUsage === 'number'
                                ? `${(totalUsage / 10000) * 100}%`
                                : '0%'
                        }}
                    ></div>
                </div>
                <h2 className='text-sm my-2'>{totalUsage.toString()}/10,000 Credit Used</h2>
            </div>
